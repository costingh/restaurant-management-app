 ...
 * 
 * This script will be used to bootstrap our NestJS backend on port 4000
 * without any Vite dependencies, allowing complete separation from the frontend.
 */
...
async function bootstrap() {
  ...
  app.use(session({
    ...
    // Use the storage provider's session store for persistence
